...
Now, my research interests lie in Natural Language Processing and Large Language Models, specifically focusing on Data-centric methods, including Data Selection, Data Synthesis, and Learning from Noisy Data. My long-term research goal is to open the black box of the impact of data during the LLMs' training and to improve the performance of LLMs using (organized, selected, or synthesized) high-quality data.
